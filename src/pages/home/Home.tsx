...
export default function Home() {
  return (
    <Layout>
      <div className="flex justify-between gap-10 p-16 container">
        <ContentHome1
          image={"/logo.png"}
          title="Thực hành"
      ...
      <div className=" bg-white py-10">
        <div className="container flex flex-col">
          <p className="text-center mb-16 text-4xl font-semibold text-[#7d9c64]">PHƯƠNG PHÁP HỌC TIẾNG NHẬT</p>
      ...
      <div className="container flex justify-center items-center p-x-10 pt-10">
        <ContentHome3/>
      </div>
    </Layout>
  );
